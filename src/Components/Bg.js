...
function Bg() {
    return (
        <>
            ...
            <div className="h-fit absolute border top-1/2 left-2/4 trans-50-revert flex w-85 my-5 md:my-0 md:w-11/12 lg:w-9/12 rounded-r-md rounded-l-md shadow-2xl" >
                <div className="bg-white w-full md:w-2/5 flex-col items-center justify-center rounded-l-md rounded-r-md md:rounded-r-none shadow-2xl ">
                    ...
                    <div className="font-extrabold text-lg mb-5 md:mb-0 lg:mb-5 lg:text-xl leading-10 text-blue-950">RESULT PORTAL</div>
                    <FormSection />
                </div>
